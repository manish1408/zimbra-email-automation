...
from app.agents.state import AgentState, IntentCategory, MessageClassification
...
class NodeContext:
    def __init__(self, email_service: EmailSyncService, settings: Settings):
...
def _dominant_intent(classifications: list[MessageClassification]) -> IntentCategory:
...
def make_nodes(ctx: NodeContext) -> dict[str, Any]:
    ...
    async def classify_intent(state: AgentState) -> dict:
        ...
        classifications: list[MessageClassification] = [
            MessageClassification(**item.model_dump()) for item in result.classifications
        ]
